...
os.makedirs("C:/Users/deepuser/Documents/awx_cont_qc_upload/modern_data_workflow/wqx_upload/upload_excel_files", exist_ok=True)
        ...
        if temperature_results:
            ...
            if (wqx_upload_df['OrganizationID'] == 'CTVOLMON').all():
                if wqx_upload_df_len + ctvolmon_len > 25000:
                    ...
                    final_ctvolmon_df.to_excel(f'C:/Users/deepuser/Documents/awx_cont_qc_upload/modern_data_workflow/wqx_upload/upload_excel_files/wqx_upload_ctvolmon_{ctvolmon_file_num}.xlsx', index=False)
                    ctvolmon_file_num += 1
                ...
                if wqx_upload_df_len + ct_dep01_wqx_len > 25000:
                    ...
                    final_ct_dep01_wqx_df.to_excel(f'C:/Users/deepuser/Documents/awx_cont_qc_upload/modern_data_workflow/wqx_upload/upload_excel_files/wqx_upload_ct_dep01_wqx_{ct_dep01_wqx_file_num}.xlsx', index=False)
                    ...
                    ct_dep01_wqx_len += wqx_upload_df_len
    #Write out both the remaining CTVOLMON and CT_DEP01_WQX dataframes after the loop is finished
    final_ctvolmon_df = pd.concat(ctvolmon_list)
    final_ctvolmon_df.to_excel(f'C:/Users/deepuser/Documents/awx_cont_qc_upload/modern_data_workflow/wqx_upload/upload_excel_files/wqx_upload_ctvolmon_{ctvolmon_file_num}.xlsx', index=False)
    final_ct_dep01_wqx_df = pd.concat(ct_dep01_wqx_list)
    final_ct_dep01_wqx_df.to_excel(f'C:/Users/deepuser/Documents/awx_cont_qc_upload/modern_data_workflow/wqx_upload/upload_excel_files/wqx_upload_ct_dep01_wqx_{ct_dep01_wqx_file_num}.xlsx', index=False)
