...
library(RMariaDB)
library(dotenv)
load_dot_env("E:/Documents/awx_cont_qc_upload/.env")
###############################################################################
...
input_main_directory = "E:/Documents/awx_cont_qc_upload/modern_data_workflow/raw_data"
rename_main_directory = "E:/Documents/awx_cont_qc_upload/modern_data_workflow/data_to_qc"
output_main_directory = "E:/Documents/awx_cont_qc_upload/modern_data_workflow/qced_data"
...
for (i in seq_along(qc_prep_files)) {
  ...
  tryCatch({
    ...
    if (nrow(df) < 5) {
      ...
      myConfig = "E:/Documents/awx_cont_qc_upload/modern_data_workflow/config_deep2.R"
